...
uaac member add analytics.zones.${analyticsRuntimeZoneId}.user analytics-ui
uaac member add analytics.zones.${analyticsCatalogZoneId}.user analytics-ui
